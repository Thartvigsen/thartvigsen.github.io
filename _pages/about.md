...
<ul style="border-radius: 8px; margin: 10px 0;">
 <li style="margin: 0; padding: 6px 0 0px 54px; list-style: none; background-image: url('images/paper_icon.png'); background-repeat: no-repeat; background-position: left top; background-size: 20px;">
