...
<ul style="border-radius: 8px; margin: 20px 0;">
 <li style="margin: 0; padding: 16px 0 16px 64px; list-style: none; background-image: url('images/paper_icon.png'); background-repeat: no-repeat; background-position: left center; background-size: 20px;">
